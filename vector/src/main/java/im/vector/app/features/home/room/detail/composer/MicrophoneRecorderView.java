...
public final class MicrophoneRecorderView extends FrameLayout implements View.OnTouchListener {
  ...
  public void onFinishInflate() {
    ...
    View recordButton = findById(this, R.id.quick_audio_toggle);
  ...
  public boolean onTouch(View v, final MotionEvent event) {
    switch (event.getAction()) {
      case MotionEvent.ACTION_DOWN:
        if (!PermissionsHasAll(getContext(), Manifest.permission.RECORD_AUDIO)) {
...
//  @Deprecated
  ...
  public static boolean PermissionsHasAll(@NonNull Context context, String... permissions) {
