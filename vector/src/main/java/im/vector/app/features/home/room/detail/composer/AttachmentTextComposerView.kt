 ...
 *
 */
@SuppressLint("ClickableViewAccessibility") class AttachmentTextComposerView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
    ...
    init {
        ...
        attachmentButton.apply {
            visibility = View.GONE
        }

        composerEditText.apply {
            hint = "Add Caption ..."
        }
